...
prot='(\.factory/|\.claude/|\.github/workflows/factory-[a-zA-Z0-9._-]*\.yml|docs/factory/CHARTER\.md|package\.json|package-lock\.json|vitest\.config\.|playwright\.config\.|tsconfig[a-zA-Z0-9._-]*\.json|\.eslintrc|eslint\.config\.|docker-compose\.test\.yml|docs/factory/runs/)'
if [ "${FACTORY_HARNESS_ISSUE:-}" = "1" ]; then
  prot='(\.factory/bin/|\.factory/lib/|\.factory/actions/|\.factory/lessons/|\.factory/scenarios/|\.factory/node_modules/|\.factory/out/[a-zA-Z0-9._-]*\.json|\.factory/out/[a-zA-Z0-9._-]*\.jsonl|\.factory/out/[a-zA-Z0-9._-]*\.pids|\.factory/out/coverage/|\.factory/out/prove-wt/|\.factory/out/classify-wt/|\.factory/ci-settings[a-zA-Z0-9._-]*\.json|\.factory/roles\.toml|\.factory/quarantine\.toml|\.factory/package\.json|\.factory/package-lock\.json|\.factory/install-manifest\.json|\.claude/|\.github/workflows/factory-[a-zA-Z0-9._-]*\.yml|docs/factory/CHARTER\.md|tsconfig[a-zA-Z0-9._-]*\.json|\.eslintrc|eslint\.config\.|docker-compose\.test\.yml|docs/factory/runs/)'
fi
# <<< factory:protected
